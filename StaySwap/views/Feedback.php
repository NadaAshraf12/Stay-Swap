...
<body>
    <div class="vid-container">
        <div class="inner-container">
            <div class="box">
                <h1>FeedBack</h1>
                <form action="../models/Feedback.php" method="POST">
                    <input type="hidden" name="sender_id" value="sender_id_goes_here" />
                    <input type="hidden" name="receiver_id" value="receiver_id_goes_here" />
                    <input type="text" name="stay_id" placeholder="StayID" />
